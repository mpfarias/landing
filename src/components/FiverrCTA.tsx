...
export function FiverrCTA() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl rounded-[2rem] border border-cyan-500/25 bg-gradient-to-br from-slate-100 via-white to-slate-100 p-8 shadow-xl shadow-cyan-900/10 sm:p-10 lg:p-14 dark:border-cyan-400/20 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 dark:shadow-2xl dark:shadow-cyan-950/30">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {m.fiverr.items.map((service) => (
            <article
              key={service.title}
              className="flex flex-col rounded-3xl border border-slate-200 bg-white/90 p-6 dark:border-white/10 dark:bg-white/[0.03]"
            >
